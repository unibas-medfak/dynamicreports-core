...
import ch.unibas.medizin.dynamicreports.jasper.base.export.AbstractJasperExcelExporter;
...
public abstract class AbstractJasperExcelExporterBuilder<T extends AbstractJasperExcelExporterBuilder<T, U>, U extends AbstractJasperExcelExporter> extends AbstractJasperExporterBuilder<T, U> {
     ...
     *
     * @param sheetDirection a {@link ch.unibas.medizin.dynamicreports.report.constant.RunDirection} object.
     * @return a T object.
     */
