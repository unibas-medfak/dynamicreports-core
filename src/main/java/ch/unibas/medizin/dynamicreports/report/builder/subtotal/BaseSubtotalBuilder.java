...
public abstract class BaseSubtotalBuilder<T extends BaseSubtotalBuilder<T, U>, U> extends AbstractBuilder<T, DRSubtotal<U>> {
     ...
     * <p>setLabelStyle.</p>
     *
     * @param labelStyle a {@link ch.unibas.medizin.dynamicreports.report.builder.style.ReportStyleBuilder} object.
     * @return a T object.
     */
     ...
     * <p>getSubtotal.</p>
     *
     * @return a {@link ch.unibas.medizin.dynamicreports.report.base.DRSubtotal} object.
     */
