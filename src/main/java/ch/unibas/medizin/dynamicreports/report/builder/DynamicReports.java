...
import ch.unibas.medizin.dynamicreports.report.builder.component.ComponentBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.condition.ConditionBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.crosstab.CrosstabBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.datatype.DataTypeBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.datatype.DataTypes;
import ch.unibas.medizin.dynamicreports.report.builder.expression.ExpressionBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.grid.GridBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.group.GroupBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.style.StyleBuilders;
import ch.unibas.medizin.dynamicreports.report.builder.subtotal.SubtotalBuilders;
...
public class DynamicReports {
     ...
     * Creates a new concatenated report builder. This report builder allows concatenating several separated reports into one single document.
     *
     * @param jasperReportHandler a {@link ch.unibas.medizin.dynamicreports.jasper.definition.JasperReportHandler} object.
     * @return a report builder
     */
     ...
     * <p>hyperLink.</p>
     *
     * @return a {@link ch.unibas.medizin.dynamicreports.report.builder.HyperLinkBuilder} object.
     */
     ...
     * <p>hyperLink.</p>
     *
     * @param linkExpression a {@link ch.unibas.medizin.dynamicreports.report.definition.expression.DRIExpression} object.
     * @return a {@link ch.unibas.medizin.dynamicreports.report.builder.HyperLinkBuilder} object.
     */
     ...
     * @param <T>   a T object.
     * @return a {@link ch.unibas.medizin.dynamicreports.report.builder.ParameterBuilder} object.
     */
     ...
     * @return a {@link ch.unibas.medizin.dynamicreports.report.builder.QueryBuilder} object.
     */
     ...
     * <p>dataset.</p>
     *
     * @return a {@link ch.unibas.medizin.dynamicreports.report.builder.DatasetBuilder} object.
     */
